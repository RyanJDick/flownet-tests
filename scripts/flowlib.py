...
def evaluate_flow_file(gt, pred):
    ...
    print("Average EPE: " + str(average_pe))
    return average_pe
...
def image_adjust(img, sz):
    ...
    """
    return scipy.misc.imresize(img, size=sz)
    
if __name__ == '__main__':
    flow_to_image_file(sys.argv[1])
    evaluate_flow_file(sys.argv[2], sys.argv[1])
